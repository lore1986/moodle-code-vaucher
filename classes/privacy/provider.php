...
/**
 * Privacy Subsystem implementation for paygw_voucher.
 *
 * @package   paygw_voucher
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace paygw_voucher\privacy;
...
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider
{
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment)
    {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_voucher');
        $record = $DB->get_record('paygw_voucher', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams)
    {
        ...
        $DB->delete_records_select('paygw_voucher', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
