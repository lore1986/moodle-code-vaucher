...
/**
 * This class contains a list of webservice functions related to the voucher payment gateway.
 *
...
namespace paygw_voucher\external;
...
class get_config_for_js extends external_api
{
    ...
    /**
     * Returns the config values required by the voucher JavaScript SDK.
     *
    ...
    public static function execute(string $component, string $paymentarea, int $itemid): array
    {
        ...
        $config = helper::get_gateway_configuration($component, $paymentarea, $itemid, 'voucher');
    ...
    public static function execute_returns(): external_single_structure
    {
        return new external_single_structure(
            [
            'clientid' => new external_value(PARAM_TEXT, 'voucher client ID'),
